...
public class CubeMovement : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (PlayerStats.canMove) {
            if ((Input.GetKeyDown(KeyCode.D) || Input.GetKeyDown(KeyCode.RightArrow)) && isMovableinDirection(Vector3.left)) {
                InitiateRoll(Vector3.left);
            }
            else if ((Input.GetKeyDown(KeyCode.A) || Input.GetKeyDown(KeyCode.LeftArrow)) && isMovableinDirection(Vector3.right)) {
                InitiateRoll(Vector3.right);
            }
            else if ((Input.GetKeyDown(KeyCode.S)  || Input.GetKeyDown(KeyCode.DownArrow))  && isMovableinDirection(Vector3.forward)) {
                InitiateRoll(Vector3.forward);
            }
            else if ((Input.GetKeyDown(KeyCode.W)  || Input.GetKeyDown(KeyCode.UpArrow)) && isMovableinDirection(Vector3.back)) {
